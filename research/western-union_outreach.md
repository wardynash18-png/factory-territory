# Western Union outreach — account_id A004

5 buying-committee slots. Western Union's headline is the **HCLTech partnership** announced 2026-05-14. **The SI owns the budget category** — tools must be pitched as `augmenting HCLTech`, not `replacing HCLTech`. That's the standing rule for every slot here.
...
HCLTech AS/400 modernization is the SI line — is there a separate internal program owner for tooling-procurement, or is everything now through the SI?
...
regulated payments + new SI. does the CISO review tooling inside the SI scope, or do non-SI tools get a separate review board?
